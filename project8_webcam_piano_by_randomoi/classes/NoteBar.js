/* 
STEP 6: Trigger secondary graphics effects or animations when an active note is drawn.
Extension 2: Used "Synthesia" a digital piano app for ipad as my source of inspiration for the 
...
Personal Note: I did not want to use noise or randomness to trigger secondary graphics for this part 
of the assignment as it would have taken away my intention for the project, which was 
to create a "human controlled piano". 
*/
