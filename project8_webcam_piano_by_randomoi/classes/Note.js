/*
Step 6 - Extension 1: Customized the base grid graphics by changing from circles to squares. 
Used for loop to create 5 overlapping squares, which are filled with random colors (retain 
until the program is refreshed). 

Step 6 - Extension 4: Implemented a custom “Note” class that is used in Grid.js. 
Instead of an array of values for noteSize, notePos and noteState 
have an array of notes. Personal note: I struggled with this part of the assignment and 
