// *******************************************************************
// BACKGROUND SUBTRACTION BASED ON THE EXAMPLE, EXTENSIVELY MODIFIED *
// *******************************************************************

var video;
var prevImg; // Step 1: renamed from the backImg to prevImg
var diffImg;
var currImg;
var thresholdSlider;
var threshold;
let grid; // Step 3: created global variable 
let monoSynths = [],
    playing;
...
function setup() {
    ...
    // Step 3: initialized grid variable in the setup() function
    // calls Grid.js the size of canvas width, height and size 40 
    grid = new Grid(canvasWidth, canvasHeight, 40);

    /*
    Step 6 – Extension 3: Implemented the core p5.js sound library to play sounds depending 
...
function draw() {
    ...
    */
    ...
    // Step 3: called "grid.run(diffImg)"
    grid.run(diffImg);
