class AsteroidSystem {
    ...
    /* STEP 11c: 
    makes the program get progressively harder by 
    spawning asteroids more frequently as time goes by
    */
    // random increment coeficient used in setInterval()
    incRndCoef() {
        this.randcoef += 0.005;
    }
}